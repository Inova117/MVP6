// Founder Handover Component - AI Lead CRM
'use client'
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-600">AI CRM deliverables</p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    {
                      role: 'Agent',
                      action: 'See hot leads first',
                      benefit: 'prioritize calls',
                    },
                    {
                      role: 'Manager',
                      action: 'Track team pipeline',
                      benefit: 'forecast revenue',
                    },
                    {
                      role: 'System',
                      action: 'Score new leads',
                      benefit: 'automate qualification',
                    },
                  ].map((story, i) => (
                    <div
                      key={i}
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-600">AI infrastructure details</p>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  title: 'MVP Launch',
                  date: 'Now',
                  desc: 'Core CRM, AI Scoring, Email Sequences',
                },
                {
                  phase: 'Phase 2',
                  title: 'LinkedIn Integration',
                  date: '+2 Months',
                  desc: 'Auto-enrich lead data via browser extension',
                },
                {
                  phase: 'Phase 3',
                  title: 'Voice AI Agent',
                  date: '+4 Months',
                  desc: 'Outbound sales calls using Voice API',
                },
              ].map((item, i) => (
