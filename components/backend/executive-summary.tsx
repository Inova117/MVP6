          ...
          <table className="min-w-full divide-y divide-slate-200">
            <thead className="bg-slate-50">
              <tr>
                ...
                <th className="px-6 py-3 text-center text-xs font-medium text-slate-900 uppercase tracking-wider bg-blue-50">
                  Our Solution
                </th>
            ...
            <tbody className="bg-white divide-y divide-slate-200">
              {[
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-center font-bold text-blue-700 bg-blue-50/50">
                    {row.us}
                  </td>
